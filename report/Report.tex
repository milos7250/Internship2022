...
\begin{figure}[H]
    ...
    \caption{A contour produced from the data by applying marching squares directly.}
    \end{subfigure}
    \hfill
    \begin{subfigure}{.49\textwidth}
        \includegraphics[width=\textwidth]{../images/3D/Dataset1_Gaussian.png}
    \caption{A contour produced from the data by applying marching squares after applying the Gaussian filter.}
    \end{subfigure}
    \caption{A contour from the first dataset from the simulation.}
    \label{fig:Dataset1}
\end{figure}
\begin{figure}[H]
    \centering
    ...
    \caption{A contour produced from the data by applying marching squares after applying the Gaussian filter.}
    \end{subfigure}
    \caption{A contour from the second dataset from the simulation.}
    \label{fig:Dataset1}
\end{figure}
